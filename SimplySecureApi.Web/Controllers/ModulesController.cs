...
namespace SimplySecureApi.Web.Controllers
{
    public class ModulesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("State,Armed,Triggered,Id,DateCreated")] Module @module)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("State,Armed,Triggered,Id,DateCreated")] Module @module)
        {
            if (id != @module.Id)
            {
                return NotFound();
